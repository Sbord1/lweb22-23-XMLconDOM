...
N.B. questo script deve essere eseguito per primo perchè genera il file xml senza il quale gli altri script potrebbero non funzionare, abbiamo optato per questa scelta per far notare come lo script crei automaticamente il "movies.xml"
